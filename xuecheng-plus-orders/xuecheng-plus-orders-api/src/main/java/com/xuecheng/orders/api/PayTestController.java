...
public class PayTestController {
    ...
    //手机(模拟器)一扫二维码请求就会进入这个接口(因为二维码就是根据这个接口的请求URL通过一个工具类生成的)，
    //然后这个接口将调用支付宝的SDK，请求支付宝下单。
    ...
    public void doPost(HttpServletRequest httpRequest,
        ...
        alipayRequest.setBizContent("{" +
                "    \"out_trade_no\":\"202410100010101002\"," +  //商户网站唯一订单号，也就是学成在线的唯一的订单号
                "    \"total_amount\":0.1," +                     //订单总金额
                "    \"subject\":\"Iphone6 16G\"," +              //商品的标题/交易标题
